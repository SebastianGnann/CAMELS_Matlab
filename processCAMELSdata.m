...
% McMillan overland flow set - note that this make take a few minutes
CAMELS_US_signatures_OverlandFlow = ...
    calc_McMillan_OverlandFlow(Q_mat_US, t_mat_US, P_mat_US, PET_mat_US);
...
save(strcat(results_path,'CAMELS_US_signatures_OverlandFlow.mat'),...
    '-struct','CAMELS_US_signatures_OverlandFlow')
