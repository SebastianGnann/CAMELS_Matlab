...
Q_temp = cellfun(@str2num,table2array(Q_table(2:end,index+1)));
P_temp = cellfun(@str2num,table2array(P_table(2:end,index+1)));
PET_temp = cellfun(@str2num,table2array(PET_table(2:end,index+1)));
T_temp = cellfun(@str2num,table2array(T_table(2:end,index+1)));
