...
runoff_ratio_mswep = cellfun(@str2num,table2array(camels_CL_data(83,2:end))');
runoff_ratio_tmpa = cellfun(@str2num,table2array(camels_CL_data(84,2:end))');
stream_elas_cr2met = cellfun(@str2num,table2array(camels_CL_data(85,2:end))');
stream_elas_chirps = cellfun(@str2num,table2array(camels_CL_data(86,2:end))');
stream_elas_mswep = cellfun(@str2num,table2array(camels_CL_data(87,2:end))');
stream_elas_tmpa = cellfun(@str2num,table2array(camels_CL_data(88,2:end))');
slope_fdc = cellfun(@str2num,table2array(camels_CL_data(89,2:end))');
baseflow_index = cellfun(@str2num,table2array(camels_CL_data(90,2:end))');
hfd_mean = cellfun(@str2num,table2array(camels_CL_data(91,2:end))');
q95 = cellfun(@str2num,table2array(camels_CL_data(92,2:end))');
q5 = cellfun(@str2num,table2array(camels_CL_data(93,2:end))');
high_q_freq = cellfun(@str2num,table2array(camels_CL_data(94,2:end))');
high_q_dur = cellfun(@str2num,table2array(camels_CL_data(95,2:end))');
low_q_freq = cellfun(@str2num,table2array(camels_CL_data(96,2:end))');
low_q_dur = cellfun(@str2num,table2array(camels_CL_data(97,2:end))');
zero_q_freq = cellfun(@str2num,table2array(camels_CL_data(98,2:end))');
swe_ratio = cellfun(@str2num,table2array(camels_CL_data(99,2:end))');
% human intervention
sur_rights_n = cellfun(@str2num,table2array(camels_CL_data(100,2:end))');
sur_rights_flow = cellfun(@str2num,table2array(camels_CL_data(101,2:end))');
interv_degree = cellfun(@str2num,table2array(camels_CL_data(102,2:end))');
gw_rights_n = cellfun(@str2num,table2array(camels_CL_data(103,2:end))');
gw_rights_flow = cellfun(@str2num,table2array(camels_CL_data(104,2:end))');
big_dam = cellfun(@str2num,table2array(camels_CL_data(105,2:end))');
